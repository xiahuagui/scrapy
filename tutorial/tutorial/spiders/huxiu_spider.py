...
class TestSpider(scrapy.Spider):
    ...
    def parse_result(self, response):
        ...
        guessyou = response.xpath('//div[@class="slider focus_list J_focus_list"]/div[@class="slider_list"]/div[@class="slider_wrapper"]/li//img/@src').extract()
        #guessyou = guessyou.decode(guessyou.encoding)
        print(guessyou)
        print(u'---------------success----------------')
